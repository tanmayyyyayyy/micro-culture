...
export async function runDemoSeed() {
  ...
  const communityDefs = [
    ...
    },
    {
      ...
      description: "Sharing projects, finding teammates, getting constructive feedback, and building cool things in public.",
      ...
      jargon: [
        ...
        "collab-ping: broadcasting project ideas to find complementary skills",
      ],
      rituals: [
      ...
      discussions: [
        { user: sneha, content: "Showcase: I built a schedule planner for weekly habits — check out the live link and let me know your thoughts!" },
        { user: ananya, content: "Looking for a collaborator to build an open-source weekend event tracker with real-time RSVPs." },
        { user: meera, content: "How do you stay motivated to finish personal side projects when work and life get busy?" },
      ],
      activityLevel: "active",
    },
    {
      key: "boundary-club",
      name: "Boundary Club",
      description: "Cricket discussions, match reactions, player stats, tournament analysis, and game strategy.",
      vibeWords: ["sports", "cricket", "matches", "ipl", "analysis"],
      aesthetic: ["pitch green", "scorecard", "leather ball", "stadium floodlights"],
      values: ["love of the game", "objective analysis", "celebrating great sportsmanship"],
      jargon: [
        "death-overs: executing yorkers and boundaries under maximum pressure",
        "swing-theory: analyzing humidity and seam position impact on conventional swing",
        "match-breakdown: tactical ball-by-ball analysis beyond the headline score",
      ],
      rituals: [
        "Log your quick tactical takeaway from the most recent match or historical game",
        "Predict player of the match for an upcoming fixture with 2 statistical reasons",
        "Share one cricket technique tip (bat grip, bowling follow-through, or slip fielding stance)",
      ],
      symbol: "🏏",
      color: "#10b981",
      creator: arjun,
      members: [arjun, dev, rohan, kabir, aditya],
      discussions: [
        { user: arjun, content: "Who has the best yorker execution in modern T20 cricket right now? Let's compare Bumrah and Starc's release points." },
        { user: dev, content: "Match reaction: that final over was pure masterclass bowling under pressure. Field placement was spot on." },
        { user: rohan, content: "Test cricket vs T20: how player fitness and stamina training has fundamentally changed in the last five years." },
      ],
      activityLevel: "highly_active",
    },
    {
      key: "lo-fi-lounge",
      name: "Lo-Fi Lounge",
      description: "Music discovery, late-night chill beats, synth vibes, sample hunting, and playlist curation.",
      vibeWords: ["music", "lofi", "playlists", "beats", "audio"],
      aesthetic: ["warm lavender", "cassette tape", "vinyl record", "sunset glow"],
      values: ["sonic warmth", "discover new artists", "curating good vibes"],
      jargon: [
        "tape-wobble: subtle pitch modulation recreating vintage cassette imperfection",
        "sample-flip: turning an old jazz chord into a fresh hip-hop groove",
        "headphone-check: testing low-end frequencies and stereo width",
      ],
      rituals: [
        "Drop your favorite track of the day with one sentence on why the melody works",
        "Spend 15 minutes listening to an instrumental album outside your comfort genre",
        "Recommend one indie producer or underground playlist to the community",
      ],
      symbol: "🎧",
      color: "#f472b6",
      creator: priya,
      members: [priya, sneha, tanvi, meera, ananya],
      discussions: [
        { user: priya, content: "Late night focus playlist drop: 30 tracks of ambient jazz hop and mellow beats for deep work. What are you listening to tonight?" },
        { user: sneha, content: "What makes a lo-fi snare sound so satisfying? Exploring bitcrushing and vinyl crackle plugins." },
        { user: meera, content: "Underrated album recommendation: 'Modal Soul' by Nujabes. A timeless blend of jazz piano and hip-hop." },
      ],
      activityLevel: "active",
    },
    {
      key: "the-reading-room",
      name: "The Reading Room",
      description: "Book recommendations, fiction reviews, non-fiction takeaways, and reading consistency.",
      vibeWords: ["books", "reading", "literature", "novels", "fiction"],
      aesthetic: ["warm cream", "hardcover spine", "coffee steam", "margin notes"],
      values: ["deep reading over scrolling", "thoughtful discussion", "diverse perspectives"],
      jargon: [
        "page-sprint: 30 minutes of distraction-free phone-away reading",
        "marginalia: jotting spontaneous thoughts and questions in physical book margins",
        "tbr-pile: the towering stack of books you are eager to read next",
      ],
      rituals: [
        "Read for 20 focused minutes today and write down the single most memorable line",
        "Write a 3-sentence summary of your current chapter or article",
        "Share a book that changed your perspective on everyday life",
      ],
      symbol: "📚",
      color: "#f59e0b",
      creator: ananya,
      members: [ananya, priya, tanvi, arjun, sneha],
      discussions: [
        { user: ananya, content: "Currently reading 'Klara and the Sun' by Kazuo Ishiguro. The perspective of an Artificial Friend is hauntingly delicate." },
        { user: priya, content: "Non-fiction recommendation: 'Atomic Habits'. The concept of making habits identity-based rather than outcome-based stuck with me." },
        { user: tanvi, content: "What is your system for retaining what you read? Physical sticky notes vs Notion book logs vs reading journals?" },
      ],
      activityLevel: "growing",
    },
    {
      key: "frame-by-frame",
      name: "Frame by Frame",
      description: "Street photography, framing critique, mobile editing tips, camera gear, and daily photo walks.",
      vibeWords: ["creative", "photography", "photos", "cameras", "editing"],
      aesthetic: ["cyan teal", "viewfinder grid", "golden hour", "film grain"],
      values: ["finding beauty in ordinary things", "generous critique", "storytelling over gear"],
      jargon: [
        "golden-hour: the 45 minutes before sunset with soft directional light",
        "rule-of-thirds: aligning focal points along intersecting grid lines",
        "shutter-drag: deliberate slow shutter speed to capture motion blur",
      ],
      rituals: [
        "Take one photo today focusing purely on shadows, reflections, or natural symmetry",
        "Critique a peer's composition with 1 positive highlight and 1 framing suggestion",
        "Share your favorite Lightroom mobile preset or editing curve recipe",
      ],
      symbol: "📷",
      color: "#06b6d4",
      creator: dev,
      members: [dev, arjun, sneha, meera, rohan],
      discussions: [
        { user: dev, content: "Street shot from yesterday's rain walk: 35mm f/1.8 with neon reflections on wet asphalt. Thoughts on the color grading?" },
        { user: sneha, content: "Mobile photography vs mirrorless: why composition and understanding natural light will always beat expensive camera bodies." },
        { user: meera, content: "Photo walk prompt for the weekend: find three instances of contrasting complementary colors in your neighborhood." },
      ],
      activityLevel: "growing",
    },
    {
      key: "game-night",
      name: "Game Night",
      description: "Indie game discoveries, weekend multiplayer lobbies, speedrun tricks, and game design discussions.",
      vibeWords: ["gaming", "games", "co-op", "multiplayer", "esports"],
      aesthetic: ["electric purple", "pixel art", "controller neon", "arcade cabinet"],
      values: ["fun first", "inclusive lobbies", "appreciating game design"],
      jargon: [
        "co-op-drop: impromptu weekend multiplayer sessions",
        "frame-perfect: timing an input within a 1/60th of a second game engine tick",
        "indie-gem: discovering overlooked handcrafted indie titles",
      ],
      rituals: [
        "Share one indie game with incredible art direction or sound design",
        "Log a 20-minute practice session or casual game check-in",
        "Discuss a game mechanic that felt exceptionally intuitive to play",
      ],
      symbol: "🎮",
      color: "#8b5cf6",
      creator: kabir,
      members: [kabir, dev, arjun, aditya, rohan],
      discussions: [
        { user: kabir, content: "Hades II mechanics discussion: how Supergiant manages weapon balancing while keeping distinct playstyles viable." },
        { user: aditya, content: "Co-op lobby alert: looking for 2 players for Helldivers 2 tonight at 9 PM. Mic optional, good vibes required!" },
        { user: dev, content: "Underrated indie game: 'Celeste' and its sublime level design teaching momentum without intrusive tutorials." },
      ],
      activityLevel: "active",
    },
    {
      key: "wander-notes",
      name: "Wander Notes",
      description: "Budget travel itineraries, backpacking stories, hidden cafe finds, and solo travel tips.",
      vibeWords: ["travel", "wander", "trips", "backpacking", "explore"],
      aesthetic: ["emerald mint", "folded map", "train ticket", "mountain ridge"],
      values: ["curiosity over tourist traps", "respecting local culture", "traveling sustainably"],
      jargon: [
        "hidden-gem: spots off tourist trails discovered by chatting with locals",
        "carry-on-only: minimalist packing strategies for multi-week journeys",
        "layover-sprint: turning a 6-hour layover into a swift city exploration",
      ],
      rituals: [
        "Share your #1 travel tip for keeping luggage light and versatile",
        "Pick a city you've never visited and map out a 48-hour walking itinerary",
        "Recommend a local dish or street market from a trip you loved",
      ],
      symbol: "✈️",
      color: "#14b8a6",
      creator: meera,
      members: [meera, ananya, tanvi, priya, arjun],
      discussions: [
        { user: meera, content: "Solo backpacking across Himachal on a 15,000 INR budget: hostels, local HRTC buses, and workation cafes." },
        { user: ananya, content: "What is your must-have travel tech accessory? Power bank vs international universal adapter vs noise-cancelling buds?" },
        { user: tanvi, content: "Train journeys in the monsoon: sharing favorite scenic rail routes and Chai stop recommendations." },
      ],
      activityLevel: "growing",
    },
    {
      key: "movie-circle",
      name: "Movie Circle",
      description: "Film critiques, weekend watchlists, director retrospectives, and spoiler-free cinema debates.",
      vibeWords: ["creative", "movies", "cinema", "films", "reviews"],
      aesthetic: ["crimson red", "cinema marquee", "35mm reel", "popcorn box"],
      values: ["deep cinephile appreciation", "spoiler etiquette", "celebrating global cinema"],
      jargon: [
        "long-take: an uninterrupted camera shot creating visceral tension",
        "subtext: themes conveyed through visual blocking rather than spoken dialogue",
        "double-bill: watching two thematically linked movies back-to-back",
      ],
      rituals: [
        "Write a 2-sentence spoiler-free review of the last movie you watched",
        "Highlight an unforgettable musical score or sound design moment in cinema",
        "Recommend one foreign language film with brilliant storytelling",
      ],
      symbol: "🎬",
      color: "#e11d48",
      creator: rohan,
      members: [rohan, priya, sneha, dev, kabir],
      discussions: [
        { user: rohan, content: "Christopher Nolan vs Denis Villeneuve: how both directors approach IMAX practical effects and sound mixing differently." },
        { user: priya, content: "Weekend watchlist: 3 modern mystery thrillers with satisfying third acts that don't rely on cheap twists." },
        { user: sneha, content: "Studio Ghibli retrospective: why the pacing and quiet 'ma' (empty space) moments make Miyazaki's worlds breathe." },
      ],
      activityLevel: "active",
    },
    {
      key: "art-corner",
      name: "Art Corner",
      description: "Daily sketch challenges, digital illustration tips, watercolor experiments, and friendly art critiques.",
      vibeWords: ["creative", "art", "drawing", "illustration", "sketching"],
      aesthetic: ["tangerine orange", "sketchbook pencil", "color palette", "brush stroke"],
      values: ["practice over perfection", "supportive feedback", "creative freedom"],
      jargon: [
        "gesture-drawing: 60-second quick sketches capturing posture and energy",
        "color-palette: selecting 3 harmonious tones to anchor an illustration",
        "daily-doodle: maintaining a sketchbook habit without pressure to finish",
      ],
      rituals: [
        "Spend 10 minutes doing a loose pencil or digital doodle of an object on your desk",
        "Share one color palette (3-4 hex codes) that inspires you today",
        "Leave an encouraging comment on another member's artwork or sketch",
      ],
      symbol: "🎨",
      color: "#fb923c",
      creator: tanvi,
      members: [tanvi, sneha, ananya, meera, priya],
      discussions: [
        { user: tanvi, content: "Overcoming the fear of the blank first page in a fresh sketchbook: try drawing a simple coffee cup or plant!" },
        { user: sneha, content: "Procreate brushes vs Photoshop pencils: comparing stroke textures for digital character illustration." },
        { user: ananya, content: "Inktober / daily drawing routine tips: how to keep consistency without artistic burnout." },
      ],
      activityLevel: "growing",
    },
  ];
